...
<h3 class="titulo">Listar Los Datos de la Equipo: <?php echo $datos['Marca']; ?><hr></h3>
  <div class="panel panel-success">
    <div class="panel-heading">
      <h3 class="panel-title">Equipo <?php echo $datos['Marca']; ?><b></b></h3>
    </div>
        ...
        <div class="col-md-9">
          <ul class="list-group">
            <li class="list-group-item">
              <b>ID: </b><?php echo $datos['ID_Equipo']; ?>
            </li>            
            <li class="list-group-item">
